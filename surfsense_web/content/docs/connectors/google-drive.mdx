...
5. Under **Authorized redirect URIs**, add:
   ```
   http://localhost:8929/api/v1/auth/google/drive/connector/callback
   ```
6. Click **Create**
...
GOOGLE_DRIVE_REDIRECT_URI=http://localhost:8929/api/v1/auth/google/drive/connector/callback
```
